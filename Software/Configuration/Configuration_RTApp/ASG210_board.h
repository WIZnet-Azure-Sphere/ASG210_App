...
#define DEVICE_BOARD_NAME	ASG210


#ifdef DEVICE_BOARD_NAME
#if 1
// 20201028 taylor
    #if (DEVICE_BOARD_NAME == ASG210)
		#define __W7500P__
		...
		#define DEVICE_ID_DEFAULT            "ASG210" // Device name
	#endif
...
*/
#endif
#if ((DEVICE_BOARD_NAME == ASG210) || (DEVICE_BOARD_NAME == WIZ750SR) || (DEVICE_BOARD_NAME == W7500P_S2E) ||(DEVICE_BOARD_NAME == WIZ750SR_1xx))	
	// LED
	#define LEDn		3
	typedef enum
	{
