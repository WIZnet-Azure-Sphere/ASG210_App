...
void set_DevConfig_to_factory_value(void)
{
	...
	#if 1
    // 20201029 taylor
    dev_config.module_type[0] = 2;
	dev_config.module_type[1] = 1;
	dev_config.module_type[2] = 1;
    #else
	...
	dev_config.network_info_common.local_ip[0] = gWIZNETINFO.ip[0];
	dev_config.network_info_common.local_ip[1] = gWIZNETINFO.ip[1];
	dev_config.network_info_common.local_ip[2] = gWIZNETINFO.ip[2];
	dev_config.network_info_common.local_ip[3] = gWIZNETINFO.ip[3];
	dev_config.network_info_common.gateway[0] = gWIZNETINFO.gw[0];
	dev_config.network_info_common.gateway[1] = gWIZNETINFO.gw[1];
	dev_config.network_info_common.gateway[2] = gWIZNETINFO.gw[2];
	dev_config.network_info_common.gateway[3] = gWIZNETINFO.gw[3];
	dev_config.network_info_common.subnet[0] = gWIZNETINFO.sn[0];
	dev_config.network_info_common.subnet[1] = gWIZNETINFO.sn[1];
	dev_config.network_info_common.subnet[2] = gWIZNETINFO.sn[2];
	dev_config.network_info_common.subnet[3] = gWIZNETINFO.sn[3];

    #if 1
    // 20201029 taylor
    dev_config.network_info_common.mac[0] = gWIZNETINFO.mac[0];
    dev_config.network_info_common.mac[1] = gWIZNETINFO.mac[1];
    dev_config.network_info_common.mac[2] = gWIZNETINFO.mac[2];
    dev_config.network_info_common.mac[3] = gWIZNETINFO.mac[3];
    dev_config.network_info_common.mac[4] = gWIZNETINFO.mac[4];
    dev_config.network_info_common.mac[5] = gWIZNETINFO.mac[5];
    #endif
...
// 20201028 taylor
    ...
    #if 1
    // 20201029 taylor
    dev_config.options.dhcp_use = SEGCP_ENABLE;
    #else
